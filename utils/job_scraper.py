...
from utils.azure_blob_storage import upload_to_blob
...
def main():
    ...
    # Upload the updated JSON file back to Azure Blob Storage
    upload_to_blob("scraped-data", "adzuna_jobs.json")
